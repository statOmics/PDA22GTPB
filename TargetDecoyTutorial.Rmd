...
The data can be found on [https://github.com/GTPB/PDA22/tree/data](https://github.com/GTPB/PDA22/tree/data).
...
```{r}
download.file("https://raw.githubusercontent.com/GTPB/PDA19/data/identification/pyrococcusMSGF%2B.mzid","pyrococcusMSGF+.mzid")
```
...
1. Download all the data from [Download data](https://github.com/statOmics/PDA/archive/refs/heads/data.zip).
